...
class Ui_simulation_ui(object):
    def setupUi(self, simulation_ui):
        ...
        self.sim_slider.setGeometry(QtCore.QRect(350, 10, 171, 371))
        font = QtGui.QFont()
        font.setPointSize(1)
        ...
        self.label_S_explanation.setGeometry(QtCore.QRect(540, 180, 431, 191))
        font = QtGui.QFont()
        font.setFamily("Cooper Black")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(40, 400, 941, 112))
